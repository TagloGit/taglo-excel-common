...
1. Read the PR: `gh pr view <number> -R TagloGit/taglo-excel-common --json title,body,url`
2. Find the linked issue from the PR body (look for "Closes #N")
3. Read the issue: `gh issue view <number> -R TagloGit/taglo-excel-common --json title,body`
4. If the issue references a spec or plan, read those files
5. Review the diff: `gh pr diff <number> -R TagloGit/taglo-excel-common`
6. Assess:
